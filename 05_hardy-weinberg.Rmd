...
O desequilíbrio de ligação decai com a distância física entre as regiões gênicas, como mostrado pela correlação (r2) nos diversos cromossomos do sorgo (Sorghum bicolor). Perceba que raças tradicionais (RT) apresentam uma taxa de decaimento maior do que linhagens endocruzantes recombinantes (LER). 

.\linebreak
```{r LDsorghum, echo = FALSE, fig.align = 'center', out.width="400px", fig.cap="O desequilíbrio de ligação decai com a distância física entre as regiões gênicas, como mostrado pela correlação (r2) nos diversos cromossomos do sorgo (Sorghum bicolor). Perceba que raças tradicionais (RT) apresentam uma taxa de decaimento maior do que linhagens endocruzantes recombinantes (LER). Ver Hu et al [2019](https://doi.org/10.3835/plantgenome2018.06.0044)."} 
...
### Exercício 4 -- Ligação gênica em SNPs
