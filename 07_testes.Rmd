...
knitr::kable(data0901, align = "cccc", booktabs = TRUE, col.names = c("BB", "Bb", "bb", "N"), caption = "Polimorfismo de cor na asa da traça de tigre escarlate (_Callimorpha dominula_).", "html")
```
.\linebreak
...
### Exercício 3 -- Equilíbrio de LIgação
